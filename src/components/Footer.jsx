        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-16 gap-y-10">
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div>
              ...
              {Bank.map((item, key) => (
                <div key={key} className="flex flex-col gap-4 lg:grid">
                  {/* Column 1 */}
                  <div className="grid grid-cols-2 lg:grid-cols-4 items-center gap-4 justify-center">
                  ...
                  {/* Column 2 */}
                  <div className="grid grid-cols-2 lg:grid-cols-3 items-center gap-4 justify-center">
